...
class HonoLoadTester:
    ...
    def __init__(self, config: HonoConfig, devices: List[Device], tenants: List[str], reporting_manager: Optional[ReportingManager] = None):
        self.config = config
        ...
        self.infrastructure_manager = InfrastructureManager(config, self.reporting_manager)
